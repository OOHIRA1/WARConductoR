...
public class Tutorial_TurenEnd : MonoBehaviour {
    ...
    [SerializeField] Image Enemy_Ap;
    [SerializeField] Image Player_Mp;
    [SerializeField] GameObject Hand;
    [SerializeField] GameObject Hand2;
    [SerializeField] Image Hand_Image;
    [SerializeField] Sprite Tutrial_Image_2;
    [SerializeField] GameObject Enemy_Samon_Unit;
    [SerializeField] Image Enemy_Samon_Unit_Image;
    [SerializeField] Sprite Enemy_Samon_Sprite;
    [SerializeField] Sprite Enemy2_Samon_Sprite;
    [SerializeField] GameObject This_Tup_Arrow;
    [SerializeField] GameObject Player_Unit_Move_5;
    [SerializeField] GameObject Player_Unit_2;
    [SerializeField] Sprite Player_Unit_Image;
    [SerializeField] GameObject Enemy_Hand_Back_Image;
    [SerializeField] GameObject Move_Enemy_Unit_12;
    [SerializeField] GameObject Move_Enemy_Unit_8;
    [SerializeField] GameObject Move_Enemy_Unit_4;
    [SerializeField] GameObject[] Enemy_AP;
    [SerializeField] GameObject[] Player_AP;
    [SerializeField] GameObject Tutorial_2;
    [SerializeField] GameObject Tap_Arow;
    [SerializeField] GameObject Farst_Tutorial;
    [SerializeField] GameObject[] Move_Unit;
    [SerializeField] GameObject[] Battle_Unit;
    [SerializeField] GameObject[] Remeining_Unit;
    [SerializeField] GameObject Tutorial_Battle;
    [SerializeField] GameObject Battle_Effect;
    [SerializeField] GameObject Battle_Player;
    [SerializeField] GameObject Battle_Enemy;
    [SerializeField] GameObject Battle_Select_Tap;
    [SerializeField] GameObject Tutorial_AP_Remaining;
    [SerializeField] GameObject Remaining_Arrow;
    [SerializeField] GameObject PoUpImgae;
    [SerializeField] GameObject Battle_Move_Button;
    [SerializeField] Sprite Farst_Player_Image_Battle;
    [SerializeField] Sprite Farst_Enemy_Image_Battle;
    [SerializeField] Sprite Second_Player_Image_Battle;
    [SerializeField] Sprite Second_Enemy_Image_Battle;
    [SerializeField] GameObject Remeining_Move_Button;
    [SerializeField] Animator Player_animation;
    [SerializeField] Animator Enemy_animation;
    [SerializeField] GameObject Effect_Tutorial;
    [SerializeField] GameObject Effect_Button;
    [SerializeField] GameObject Effect_move;
    [SerializeField] Image PopUpImage_Sprite;
    [SerializeField] Sprite Effect_unit_Sprite;
    [SerializeField] GameObject Effect_Tap;
    [SerializeField] GameObject Effect_Unit_4;
    [SerializeField] GameObject Tutorial_Win1;
    [SerializeField] GameObject Tutorial_Win2;
    [SerializeField] GameObject Tutorial_Win3;
    [SerializeField] GameObject Tutorial_Unit_16;
    [SerializeField] GameObject Win_Tap;
    [SerializeField] GameObject Last_Move;
    [SerializeField] GameObject Last_Effect;
    [SerializeField] GameObject Last_Attack;
    [SerializeField] GameObject Life_Damege;
    [SerializeField] GameObject Unit_0;
    [SerializeField] Sprite[] Cemetary_Font;
    [SerializeField] GameObject Enemy_cemetary;
    [SerializeField] GameObject Player_cemetary;
    [SerializeField] GameObject Player_Trun;
    [SerializeField] GameObject Enemy_Trun;
    [SerializeField] GameObject Win;
    [SerializeField] GameObject Zangeki;
    [SerializeField] Sprite Damege_Rivaiusun;
    [SerializeField] Sprite Damege_uvad;
